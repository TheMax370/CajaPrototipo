...
{
    public partial class DepositarCuenta : Form
    {
        ...
        private void retirarBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Database.AgregarTransaccion(Usuario, "Deposito a Cuenta", d, DateTime.Now.ToString("M/d/yyyy"));
                Database.AgregarTransaccion(tbo_usuario.Text, "Deposito", d, DateTime.Now.ToString("M/d/yyyy"));
                ...
                Program.log.Info("DepositarCuenta : " + d + " withdrawl to = " + tbo_usuario.Text);
